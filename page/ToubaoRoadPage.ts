...
module gametoubao.page {
	export class ToubaoRoadPage extends game.gui.base.Page {
		private _viewUI: ui.game_ui.toubao.TouBao_ZouShiTuUI;
	...
	class MapRecordRender extends ui.game_ui.toubao.component.RecordRenderUI {
		private _game: Game;
		private _data: any;
		constructor() {
			super();
	...
	class ResultRender extends ui.game_ui.toubao.component.ZouShiDaXiaoUI {
		private _game: Game;
		private _data: any;
		constructor() {
			super();
